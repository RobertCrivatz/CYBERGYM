					...
					<div class="col-md-6 form-group">
						...
						<label for="producttype">Product Type</label> <select name="type"
							...
							<option value="proteine"
								<%="mobile".equalsIgnoreCase(ptype) ? "selected" : ""%>>PROTEINE</option>
							<option value="aminoacizi"
								<%="tv".equalsIgnoreCase(ptype) ? "selected" : ""%>>AMINOACIZI</option>
							<option value="vitamine"
								<%="camera".equalsIgnoreCase(ptype) ? "selected" : ""%>>VITAMINE</option>
							<option value="creatina"
								<%="laptop".equalsIgnoreCase(ptype) ? "selected" : ""%>>CREATINA</option>
							<option value="PREWORKOUT"
								<%="tablet".equalsIgnoreCase(ptype) ? "selected" : ""%>>PREWORKOUT</option>
							<option value="antioxidanti"
								<%="speaker".equalsIgnoreCase(ptype) ? "selected" : ""%>>ANTIOXIDANTI</option>
							<option value="other"
